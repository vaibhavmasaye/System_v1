...
public class AccountManagers {
	...
	public AccountManagers(Integer id, Customer customer, String email, String name, String phone) {
		super();
	...
	public String toString() {
		return "AccountManagers [id=" + id + ", customer=" + customer + ", email=" + email + ", name=" + name
	...
	public AccountManagers(String email, String name, String phone) {
		super();
		this.email = email;
		this.name = name;
		this.phone = phone;
